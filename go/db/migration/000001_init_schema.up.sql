...
CREATE INDEX ON "authors" ("user");

CREATE INDEX ON "students" ("user");

CREATE INDEX ON "speakers" ("user");

CREATE INDEX ON "enrollment" ("student");

ALTER TABLE "verify_emails" ADD FOREIGN KEY ("username") REFERENCES "users" ("username");

ALTER TABLE "authors" ADD FOREIGN KEY ("user") REFERENCES "users" ("username");

ALTER TABLE "students" ADD FOREIGN KEY ("user") REFERENCES "users" ("username");

ALTER TABLE "speakers" ADD FOREIGN KEY ("user") REFERENCES "users" ("username");

ALTER TABLE "enrollment_payment" ADD FOREIGN KEY ("enrollment_id") REFERENCES "enrollment" ("id");

ALTER TABLE "enrollment_courses" ADD FOREIGN KEY ("student_name") REFERENCES "enrollment" ("student");

ALTER TABLE "enrollment_events" ADD FOREIGN KEY ("enrollment_id") REFERENCES "enrollment" ("id");

ALTER TABLE "events" ADD FOREIGN KEY ("speaker") REFERENCES "speakers" ("user");

ALTER TABLE "courses" ADD FOREIGN KEY ("author_id") REFERENCES "authors" ("user");

ALTER TABLE "enrollment" ADD FOREIGN KEY ("student") REFERENCES "students" ("user");

ALTER TABLE "sessions" ADD FOREIGN KEY ("username") REFERENCES "users" ("username");

ALTER TABLE "ratings" ADD FOREIGN KEY ("reviewer") REFERENCES "enrollment" ("student");
